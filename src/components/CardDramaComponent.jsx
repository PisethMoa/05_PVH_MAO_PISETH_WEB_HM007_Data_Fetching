import { getGenreDramaMovieService } from "@/services/movie.service";
import React from "react";

const CardDramaComponent = async () => {
  const dramaMovies = await getGenreDramaMovieService("Drama");
  return (
    <div className="overflow-x-auto no-scrollbar">
      <div className="flex flex-nowrap">
        {dramaMovies.payload.map((data) => (
          <a
            key={data.movie_id}
...
export default CardDramaComponent;
